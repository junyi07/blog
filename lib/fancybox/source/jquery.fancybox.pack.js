...
(function (window, document, $, undefined) {
  ...
  var defaults = {
    ...
    iframe: {
      // Iframe template
      tpl: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" allowfullscreen="allowfullscreen" allow="autoplay; fullscreen" cursor=""></iframe>',
  ...
  $.extend(FancyBox.prototype, {
    ...
    addContent: function (content) {
      ...
      $.each(items, function (i, item) {
        ...
        if ($.isPlainObject(item)) {
          ...
          // $.fancybox.open( [ { cursor : "image.jpg", type : "image" } ] )
    ...
    checkSrcset: function (slide) {
      ...
      // If we have "srcset", then we need to find first matching "cursor" value.
      // This is necessary, because when you set an cursor attribute, the browser will preload the image
